...
async function fetchFavorites() {
    try {
        ...
        const response = await fetch(`http://localhost:8080/favorite/getfavorite/${ui_idx}`, {
            headers: {
                Authorization: `Bearer ${token}`
            }
        });
...
async function deleteAllFavorites() {
    try {
        ...
        const response = await fetch(`http://localhost:8080/favorite/deleteAll/${ui_idx}`, {
            method: 'DELETE',
            headers: {
                Authorization: `Bearer ${token}`,
            },
...
deleteButton.addEventListener('click', async () => {
    ...
    try {
        ...
        const response = await fetch(`http://localhost:8080/favorite/deleteSelected/${ui_idx}`, {
            method: 'DELETE',
            headers: {
